...
abstract contract AbstractPyth is IPyth {
    ...
    /// @notice This function is deprecated and is only kept for backward compatibility.
    function getPrice(bytes32 id) external view virtual returns (PythStructs.Price memory price) {
        return getPriceNoOlderThan(id, getValidTimePeriod());
    }

    /// @notice This function is deprecated and is only kept for backward compatibility.
    function getEmaPrice(bytes32 id) external view virtual returns (PythStructs.Price memory price) {
